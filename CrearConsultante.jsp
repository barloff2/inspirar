                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "form-group">
                                <label for="txtID">Número de documento</label>
                            ...
                            <div class = "form-group">
                                ...
                                <input type="text" required class="form-control" value="" name="txtNombre" id="txtNombre">
                            </div>
    
                            <div class = "form-group">
                                <label for="txtFecha">Fecha Nacimiento</label>
                                <input type="date" required class="form-control" value="" name="txtFecha" id="txtFecha">
                            </div>
    
                            <div class = "form-group">
                                <label for="txtGenero">Genero</label>
                                <input type="text" required class="form-control" value="" name="txtGenero" id="txtGenero">
                            </div>
                            ...
                            <div class = "form-group">
                                ...
                                <input type="text" required class="form-control" value="" name="txtEscolaridad" id="txtEscolaridad">
                            </div>
    
                            <div class = "form-group">
                                <label for="txtOcupacion">Ocupacion</label>
                                <input type="text" required class="form-control" value="" name="txtOcupacion" id="txtOcupacion">
                            </div>
    
                            <div class = "form-group">
                                <label for="txtPais">País</label>
                                <input type="text" required class="form-control" value="" name="txtPais" id="txtPais">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">    
                            <div class = "form-group">
                                ...
                                <input type="text" required class="form-control" value="" name="txtCiudad" id="txtCiudad">
                            </div>
    
                            
                            <div class = "form-group">
                                <label for="txtLocalidad">Localidad</label>
                                <input type="text" required class="form-control" value="" name="txtLocalidad" id="txtLocalidad">
                            </div>
    
                            
                            <div class = "form-group">
                                <label for="txtBarrio">Barrio</label>
                                <input type="text" required class="form-control" value="" name="txtBarrio" id="txtBarrio">
                            </div>
    
                            
                            <div class = "form-group">
                                <label for="txtDireccion">Dirección</label>
                                <input type="text" required class="form-control" value="" name="txtDireccion" id="txtDireccion">
                            </div>
    
                            <div class = "form-group">
                                <label for="txtTelefono">Telefono Fijo</label>
                                <input type="text" required class="form-control" value="" name="txtTelefono" id="txtTelefono">
                            </div>
    
                            <div class = "form-group">
                                <label for="txtCelular">Celular</label>
                                <input type="text" required class="form-control" value="" name="txtCelular" id="txtCelular">
                            </div>
    
                            <div class = "form-group">
                                <label for="txtCorreo">Correo</label>
                                <input type="email" required class="form-control" value="" name="txtCorreo" id="txtCorreo">
                            </div>
    
                            <div class = "form-group">
                                <label for="txtEPS">EPS</label>
                                <input type="text" required class="form-control" value="" name="txtEPS" id="txtEPS">
                            </div>
    
                            <div class = "form-group">
                                <label for="txtRegimen">Regimen</label><br>
                                <select id="txtRegimen">
        ...
        <table class="table table-bordered">
            <thead>
                <tr>
                    ...
                    <td>
                        <form method="POST">
                            <input type="hidden" name="txtID" id="txtID" value="<?php echo $consultante['documento_identidad']; ?>"/>
                                <input type="submit" name="accion"  value="Seleccionar" class="btn btn-primary btn-sm"/>
                                
                            <input type="submit" name="accion"  value="Inactivar" class="btn btn-primary btn-sm"/>
