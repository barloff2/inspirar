...
class MnFooter extends HTMLElement {
  ...
  <div class="carousel-inner">
	...
	<div class="carousel-item">
	  <svg class="bd-placeholder-img" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" preserveAspectRatio="xMidYMid slice" focusable="false"><rect width="100%" height="100%" fill="#93a8c7"/></svg>

	  <div class="container" style="padding-top: 2rem">
		<div class="carousel-caption text-start">
		  <h1>Visión</h1>
		  <p>Consolidarnos como un referente de inspiración, calidad y pluralismo, que utiliza la Psicología como herramienta para dar respuesta a cualquier necesidad planteada por nuestros clientes.</p>
		</div>
	  </div>
	</div>
  </div>
  ...
  <a href="index.jsp" class="nav-link px-2 text-muted"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house" viewBox="0 0 16 16">
